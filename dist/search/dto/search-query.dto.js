...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'wireless earbuds' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'merch_01HZ...' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], SearchQueryDto.prototype, "merchant", void 0);
__decorate([
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 4.0, description: 'Minimum average rating' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(1),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 25, description: 'Minimum discount percent (e.g. 25 => 25%+ off)' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Type)(() => Number),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.Min)(0),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Only show in-stock products' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Only show featured products' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_transformer_1.Transform)(({ value }) => value === 'true' || value === true),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], SearchQueryDto.prototype, "featured", void 0);
__decorate([
